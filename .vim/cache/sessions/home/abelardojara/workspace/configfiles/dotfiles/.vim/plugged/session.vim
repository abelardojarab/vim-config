...
imap <expr> <C-L> empty(complete_info(['mode']).mode) ? "<Plug>CapsLockToggle" : ""
...
nnoremap \ga :GitGutterStageHunk
nmap \k <Plug>(GitGutterPrevHunk)zz
nmap \j <Plug>(GitGutterNextHunk)zz
map \d <Plug>NERDTreeToggle
...
nnoremap <silent> <Plug>(ctrlp) :CtrlPBuffer
nnoremap <C-B> :OpenSession
map <C-T> :NERDTreeToggle
map <C-N> :bnext
map <C-P> <Plug>(ctrlp)
map <C-PageDown> :bnext
map <C-PageUp> :bprevCR>
map <C-Right> :bnext
map <C-Left> :bprev
nmap <C-W> :vertical resize +5
...
imap <expr>  empty(complete_info(['mode']).mode) ? "<Plug>CapsLockToggle" : ""
inoremap <expr>  pumvisible() ? "\\" : "\"
inoremap  :updategi
inoremap  
inoremap  u
...
imap <silent>  <Plug>TComment_
nmap ì <Plug>MoveCharRight
nmap è <Plug>MoveCharLeft
...
set report=0
set ruler
set runtimepath=~/.vim,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/syntastic/,~/.vim/plugged/vim-surround/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/vim-buftabline/,~/.vim/plugged/vim-nerdtree-direnter/,~/.vim/plugged/minibufexpl.vim/,~/.vim/plugged/vim-clang-format/,~/.vim/plugged/mru/,~/.vim/plugged/asyncomplete.vim/,~/.vim/plugged/vim-lsp/,~/.vim/plugged/asyncomplete-lsp.vim/,~/.vim/plugged/vim-gitgutter/,~/.vim/plugged/gv.vim/,~/.vim/plugged/deoplete.nvim/,~/.vim/plugged/context_filetype.vim/,~/.vim/plugged/vim-tmux-navigator/,~/.vim/plugged/ale/,~/.vim/plugged/fzf/,~/.vim/plugged/fzf.vim/,~/.vim/plugged/undotree/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/deoplete-jedi/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/tabular/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/vim-closetag/,~/.vim/plugged/vim-repeat/,~/.vim/plugged/vim-capslock/,~/.vim/plugged/targets.vim/,~/.vim/plugged/vim-sort-motion/,~/.vim/plugged/vim-expand-region/,~/.vim/plugged/MatchTagAlways/,~/.vim/plugged/vim-argwrap/,~/.vim/plugged/vim-md-headings/,~/.vim/plugged/vim-move/,~/.vim/plugged/vim-atomic/,~/.vim/plugged/vim-airline-themes/,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/tabular/after,~/.vim/after
set scrolloff=5
...
silent only
silent tabonly
cd ~/workspace/configfiles/dotfiles/.vim/plugged
